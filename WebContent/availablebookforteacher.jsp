...
<%@page import="com.org.model.AvailableBookForTeacherModel"%>
...
<title>Available Books for teachers</title>
<meta charset="utf-8">
...
<div class="row justify-content-center">
  <form class="form-inline" action="TeachersSearchController" method="post">
...
<%ArrayList<AvailableBookForTeacherModel> arr=(ArrayList)request.getAttribute("result");
...
<%while(list.hasNext()) { AvailableBookForTeacherModel ab=(AvailableBookForTeacherModel)list.next(); %>
<section class="container">
