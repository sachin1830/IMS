...
<%@page import="com.org.model.SearchModel"%>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-5">
      <li class="nav-item active">
        <a class="nav-link " href="Searchresult.jsp">Home <span class="sr-only">(current)</span></a>
      </li>
...
<%ArrayList<SearchModel>arr=(ArrayList)request.getAttribute("search"); 
...
<%while(list.hasNext()){ SearchModel sm=(SearchModel)list.next();%>
<section class="container">
